...
# Leer predicciones
# -----------------------------
file_path = "/Users/pedro.lucioglovoapp.com/PycharmProjects/PLECA/Drinks/predicciones_productos_KG_5_MultilingualBERT.csv"
...
# -----------------------------
df.to_csv("test products_KG_6.csv", index=False)
